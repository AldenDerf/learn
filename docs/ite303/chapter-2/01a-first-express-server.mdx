...
In **[2.1.2 Understanding the Request/Response Lifecycle](/web-systems/chapter-2/request-response-lifecycle)**, you will learn how a route can receive values from the path and query string. For now, make sure you can build, run, explain, and change the simple server from this lesson.

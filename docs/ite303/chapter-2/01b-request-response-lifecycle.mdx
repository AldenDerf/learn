...
In **[2.1.3 Middleware & Building a Complete Express Server](/web-systems/chapter-2/middleware-complete-server)**, you will meet middleware and see how Express can place shared steps into the request lifecycle. You do not need to write middleware yet. First, make sure you can trace the lifecycle from this lesson without guessing.
